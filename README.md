...
| [INT8 R2V (javano2609.2.2)](https://huggingface.co/javawock7618/comfy-MiniMax-H3-workflows/resolve/main/MiniMax_int8_R2V-javano2609.2.2.json) | javawock7618 | Ref2VA | INT8 low-VRAM reference-to-video workflow — Reference LoRA, ControlNet Union V2V, Extend, and Latent Upscaler. Current version (older 2608.x/2609.1.x/2609.2.1 files removed from the repo). |
